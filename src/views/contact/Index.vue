    ...
    <div class="post-index">
        ...
        <header class="pt-5 border-bottom bg-light">
            <div class="container pt-md-1 pb-md-1">
                ...
                <p class="bd-lead">Kontak SD - IT Salemba Bluntas</p>
            </div>
        </header>
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><router-link :to="{ name: 'contact' }" class="text-decoration-none"><i class="fa fa-phone"></i> Kontak</router-link></li>
        </ol>
        </nav>
        <!-- end breadcrumb -->
                ...
                <div class="col-md-5">
                    <div class="card border-0 shadow-sm rounded">
                        <div class="card-body">
                            ...
                            <hr>
                            <p>
                                <i class="fa fa-map-marker" aria-hidden="true"></i> Jl. Salemba Bluntas nomor 55, Senen Jakarta Pusat, Indonesia
                                <i class="fas fa-phone"></i> 081 222 333 444

                                <i class="fas fa-envelope"></i> info@sdit_salemba_bluntas.sch.id
                            </p>
                        </div>
                    </div>
                </div>
